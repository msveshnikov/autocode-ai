ssh -l ubuntu allchat.online "docker exec autocode_mongo_1 mongoexport --db autocode --type csv --collection users --fields _id,email,tier,subscriptionStatus,stripeSubscriptionId,stripeCustomerId,ip,devices,dailyRequests >users.csv"
